      ...
      >
          ...
          <Grid item sx={{ width: "100%" }}>
            ...
            >
              ...
              <Typography
                ...
                sx={{ color: "#456882" }}
              >
                مسیر توسعه فرانتاند را با انگیزه یادگیری عمیق و عالقه به حل
                مسئله دنبال میکنم.. تمرکز من بر ساخت رابطهای کاربریایست که در
                عین زیبایی بصری، ساده، کاربردی و قابل اعتماد باشند. طی یک سال
                گذشته، با پروژههای تمرینی کار کردهام و با ذهنی کنجکاو ، مهارتهای
                خود را در عمل تقویت کردهام. در حال حاضر دانشجوی مهندسی نرمافزارم
                و بهدنبال فرصتی هستم برای پیوستن به تیمی حرفهای که در آن بتوانم
                یاد بگیرم، رشد کنم و نقش مؤثری در ساخت محصوالت ارزشمند ایفا کنم
              </Typography>
            </Box>
          </Grid>
        </Grid>
        ...
        >
          ...
          >
            ...
            >
              <source
                src={`${import.meta.env.BASE_URL}film/commerce.mp4`}
                type="video/mp4"
              />
            </video>
          </Box>
        ...
        >
          ...
          >
            ...
            >
              <source
                src={`${import.meta.env.BASE_URL}film/Login Form.mp4`}
                type="video/mp4"
              />
            </video>
          </Box>
        ...
        >
          ...
          >
            ...
            >
              <source
                src={`${import.meta.env.BASE_URL}film/keyboard.mp4`}
                type="video/mp4"
              />
            </video>
          </Box>
        ...
        >
          ...
          >
            ...
            >
              <source
                src={`${import.meta.env.BASE_URL}film/General Project.mp4`}
                type="video/mp4"
              />
            </video>
          </Box>
